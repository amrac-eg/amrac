...
const translations = {
  ar: {
    ...
    vision: {
      title: "رؤيتنا",
      description: "أن نكون شركاء في بناء بيئات أكثر ذكاءً وحياة أفضل لمجتمعاتنا"
    },
    mission: {
      title: "رسالتنا",
      description: "تسعى أمراك لتكون إحدى العلامات البارزة في صناعة التصميم المعماري والهندسي في مصر والمنطقة، من خلال التزامها بالجودة، وحفاظها على الطابع المحلي الأصيل، وتطلّعها المستمر نحو التميّز والريادة."
    }
  },
  en: {
    badge: "About Us",
    title: "Amrak Engineering Consultancy",
    subtitle: "Designing your projects with confidence and proven expertise.",
    description: "A specialized company providing engineering solutions and consultations with over a decade and a half of experience in local and regional markets. We offer precise engineering consulting services based on understanding our clients' needs and employing the latest international standards. We believe that proper planning is the foundation of success, so we focus on details and provide integrated solutions that ensure efficient and high-quality execution. Our vision is to be partners in building smarter environments and better lives for our communities.",
    ...
    vision: {
      title: "Our Vision",
      description: "To be partners in building smarter environments and better lives for our communities"
    },
    mission: {
      title: "Our Mission",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`space-y-8 ${isRTL ? 'text-right' : 'text-left'}`}>
            ...
            <div className="space-y-4">
              <span className={`inline-flex items-center gap-2 text-primary font-medium ${isRTL ? 'flex-row' : 'flex-row-reverse'}`}>
            ...
            <div className="space-y-6 text-gray-600 leading-relaxed">
              ...
              {/* Experience */}
              <div className={`flex items-center gap-6 bg-white p-6 rounded-xl shadow-sm border ${isRTL ? 'flex-row' : 'flex-row'}`}>
                <div className="text-primary text-4xl font-bold">+15</div>
                <div>
                  <p className="font-semibold text-gray-900">{t.experienceLabel}</p>
          ...
          <div className="relative h-full">
            ...
            {/* Badge */}
            <div className={`absolute -bottom-8 ${isRTL ? '-left-8' : '-right-8'} bg-primary text-white p-6 rounded-2xl shadow-lg`}>
