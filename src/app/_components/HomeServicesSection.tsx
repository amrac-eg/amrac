...
const HomeServicesSection = ({ services }: ServicesTableProps) => {
  useEffect(() => {
    AOS.init({
      duration: 800,
      once: true,
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            حلول هندسية متكاملة تلبي احتياجاتك بدقة واحترافية
          </p>
        </div>
        ...
        >
          <Button
            ...
            asChild
          >
            <Link href={`${Routes.SERVICES}`}>اكتشف جميع خدماتنا</Link>
          </Button>
        </div>
      </div>
